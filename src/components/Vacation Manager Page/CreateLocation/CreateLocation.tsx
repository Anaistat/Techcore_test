        ...
        <form>
            <ul className={style['form-container']}>
                ...
                <li className={style['expiry-date']}>
                    <Checkbox label={'No Brought Forward Expiry Date'} name='expiry-date' boldFont={true}/>
                ...
                <li className={style['timezone']}>
                    ...
                    <Info text={`This default time zone is used throughout the system. For example for accurately 
                    displaying leave information in the calendar and for the system events listed in the Logs.`}/>
                </li>
                <li className={style['add-users']}>
                    <Input type='text' placeholder='Add Users'/>
                </li>
                <li className={style['default-location']}>
                    <Checkbox label='Make This Location Default' boldFont={true} name='default-location'/>
                    <Info text={`By making this Location the default one, all new team members will be 
                    automatically added to this Location.`}/>
                </li>
